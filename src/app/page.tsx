...
const pricingPlans: Plan[] = [
  {
    ...
    features: ["7-day meal plans", "Grocery list", "Up to 4 people", "No credit card needed"],
    cta: "Start free",
    highlight: false,
    badge: null,
  },
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: BG, color: DARK }}>
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        <span className="text-lg font-semibold tracking-tight" style={{ color: SAGE }}>
          ClearMyPlate
        </span>
        <Button
          variant="outline"
      ...
      <footer className="mx-auto max-w-6xl px-6 py-10">
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          <span className="text-sm font-semibold" style={{ color: SAGE }}>ClearMyPlate</span>
